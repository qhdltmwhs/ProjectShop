...
--insert jumun_detail
--insert jumun_detail
insert into jumun(j_no, j_desc, j_date, j_price, userid) values (jumun_j_no_seq.nextval, '비글외1종', sysdate, 2600000, 'guard1');
insert into jumun_detail(jd_no, jd_qty, j_no, p_no) values(JUMUN_DETAIL_JD_NO_SEQ.nextval, 2, jumun_j_no_seq.currval, 1);
insert into jumun_detail(jd_no, jd_qty, j_no, p_no) values(JUMUN_DETAIL_JD_NO_SEQ.nextval, 3, jumun_j_no_seq.currval, 2);

insert into jumun values (jumun_j_no_seq.nextval, '비글외0종', sysdate, 1100000, 'guard1');
...
--insert jumun_detail
--insert jumun_detail
insert into jumun(j_no, j_desc, j_date, j_price, userid) values (jumun_j_no_seq.nextval, '비글외2종', sysdate, 9900000, 'guard2');
...
insert into jumun_detail(jd_no, jd_qty, j_no, p_no) values(JUMUN_DETAIL_JD_NO_SEQ.nextval, 2, jumun_j_no_seq.currval, 4);
